        ...
        <div class="card-body">
            <form action="{{ route('admin.resident.update', $resident->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    @enderror" id="name" name="name" value="{{ old('name', $resident->user->name) }}">
                ...
                <div class="form-group">
                    ...
                    @enderror" id="email" name="email" value="{{ old('email', $resident->user->email) }}" readonly>
                ...
                <div class="form-group">
                    ...
                    @enderror" id="avatar" name="avatar">
                </div>
